...
$lang = array_merge($lang, array(
	...
	'ACTIVITY_STATS_CHECK_PERMISSIONS_EXP'		=> 'no=chiunque pu&ograve; vedere le statistiche attive (ignora permessi ed impostazioni); yes=usa i premessi configurati (e.s. permettere solo agli utenti registrati: ACP->permissi->permessi globali -> permissi di gruppo -> utenti registrati -> permessi avanzati -> varie -> "Possono vedere le statistiche attive")',
